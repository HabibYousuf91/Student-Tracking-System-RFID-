...
{
	/// <summary>
	/// File generated by: Code Generator v. 1.0.0.1
	/// File generated on: 08 October, 2019. 23:43
	/// Database used: AttendancePortal.
	/// </summary>
	public partial class StudentMst : BaseClass
	{
		#region Disposable
		...
		const string Query_SelectAll_WithPaging = @" SELECT [SID], [RollNo], [Name], [StdName], [DivName], [Email], [Mobile], [DOB], [Image], [Add], [City], [Pincode], [Uname], [Pass], [EDate], ROW_NUMBER() Over (Order by SID) as 'Row' FROM [StudentMst] "; 

		const string Query_SelectAll_WithoutPaging = @" SELECT [SID], [RollNo], [Name], [StdName], [DivName], [Email], [Mobile], [DOB], [Image], [Add], [City], [Pincode], [Uname], [Pass], [EDate] FROM [StudentMst] "; 
		...
		const string Query_Insert = @" INSERT INTO [StudentMst] ([SID], [RollNo], [Name], [StdName], [DivName], [Email], [Mobile], [DOB], [Image], [Add], [City], [Pincode], [Uname], [Pass], [EDate])
		VALUES(@SID, @RollNo, @Name, @StdName, @DivName, @Email, @Mobile, @DOB, @Image, @Add, @City, @Pincode, @Uname, @Pass, @EDate) ";

		const string Query_Update_By_PrimaryKey = @" UPDATE [StudentMst] SET [RollNo] = @RollNo, [Name] = @Name, [StdName] = @StdName, [DivName] = @DivName, [Email] = @Email, [Mobile] = @Mobile, [DOB] = @DOB, [Image] = @Image, [Add] = @Add, [City] = @City, [Pincode] = @Pincode, [Uname] = @Uname, [Pass] = @Pass, [EDate] = @EDate
		WHERE [SID] = @SID ";
