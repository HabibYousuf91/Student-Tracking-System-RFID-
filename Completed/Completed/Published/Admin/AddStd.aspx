<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeBehind="AddStd.aspx.cs" Inherits="AttendancePortal.Admin.AddStd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="tbl">
        <tr>
            <td class="tblhead">ADD Standard</td>
        </tr>
        <tr>
            <td class="style3"></td>
        </tr>
        <tr>
            <td>
                ...
                <br />
                <hr />
                <asp:GridView ID="GvStd" runat="server" AutoGenerateColumns="False" DataKeyNames="SID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Standard Name" ItemStyle-Width="80%">
                            <ItemTemplate>
