<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Staff/Staff.master" CodeBehind="Default.aspx.cs" Inherits="AttendancePortal.Staff.Default" %>
    ...
    <style type="text/css">
        ...
        <script type="text/javascript">
            function fadeLabelOut() {
                debugger;
                $('#<%=lblcnt.ClientID%>').fadeOut(4000, function () {
